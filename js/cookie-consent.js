(function () {
  ...
  function ensureBanner() {
    ...
    bar.innerHTML =
      ...
      '<p id="cookie-banner-desc" class="cookie-banner-desc">Technisch notwendige Speicherung verwenden wir nur für Ihre Datenschutzauswahl. Statistik (Google Analytics) nur mit Ihrer Einwilligung. Details in der <a href="/datenschutz.html">Datenschutzerklärung</a>.</p>' +
      "</div>" +
